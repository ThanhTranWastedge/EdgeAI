...
export const btnPrimaryCls =
  'px-6 py-2 rounded-full bg-amcs-primary text-white text-sm font-medium hover:bg-amcs-primary-hover focus:outline-none focus:ring-2 focus:ring-amcs-primary-light/30 transition-colors cursor-pointer'
